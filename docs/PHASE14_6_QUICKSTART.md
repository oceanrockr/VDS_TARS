...
- [Retrospective Generator Source](../scripts/generate_retrospective.py) - Full source code with inline docs
- [Test Suite](../tests/test_retrospective_generator.py) - Unit and integration tests
